                ...
                <Layout style={{ flex: 1, paddingLeft: '3%', paddingRight: '3%', paddingBottom: '3%' }}>
                    <Layout style={{ paddingBottom: '5%' }}>
                        <Layout style={{ flex: 1, paddingTop: '3%', paddingBottom: '2%', display: 'flex', flexDirection: 'row' }}>
                            <BackButton />
                            <Text style={{ textAlign: 'left', paddingLeft: '3%',fontSize: 25, marginBottom: '3%', fontFamily: SF_UI_Display_Bold }} category='s2'>Create your account</Text>
                        </Layout>
                            ...
                            return (
                                <>
                                    ...
                                    <Button
                                        ...
                                        {() => <Text style={{ fontFamily: SF_UI_Display_Bold, color: loading ? "#ACB1C0" : 'white', fontSize: 18 }}>Sign up</Text>}
                                    </Button>
                                </>
                            );
                        }}

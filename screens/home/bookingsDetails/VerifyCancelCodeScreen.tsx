    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <Layout style={{ flex: 1, padding: '5%', backgroundColor: 'white' }}>
        ...
        <Button
          ...
          {() => <Text style={{ color: 'white', fontFamily: SF_UI_Display_Bold, fontSize: 18 }}>Verify</Text>}
        </Button>

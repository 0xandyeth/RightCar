                            ...
                            return (
                                <>
                                    <TabView
                                        ...
                                        <Tab style={{ paddingTop: '6%', paddingBottom: '1%' }} title={evaProps => <Text {...evaProps} style={{ fontFamily: SF_UI_Display_Bold, color: selectedIndex == 0 ? '#41d5fb' : '#aeb1c3' }}>PROFILE</Text>} >
                                            <>
                                                <Input
                                        ...
                                        <Tab style={{ paddingTop: '6%', paddingBottom: '1%' }} title={evaProps => <Text {...evaProps} style={{ fontFamily: SF_UI_Display_Bold, color: selectedIndex == 1 ? '#41d5fb' : '#aeb1c3' }}>DOCUMENTS</Text>} >
                                            <>
                                                {profile?.passimage != "" ? (
                                                    <TimeCheckbox
                                                        replaceCheckbox={() => {

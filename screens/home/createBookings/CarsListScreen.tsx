    ...
    <SafeAreaView style={{ flex: 1, alignItems: 'center', backgroundColor: 'white' }}>
                    ...
                    <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', backgroundColor: '#41d5fb', marginBottom: '2%' }}>
                      <View style={{ padding: '3%' }}>
                        <View style={{ width: '100%' }}>
                          <Text style={{ fontSize: 18, textAlign: 'left', fontFamily: SF_UI_Display_Bold }}>{route.params.searchParams.pickUpLocation.locationname}</Text>
                          <Text style={{ fontSize: 15, textAlign: 'left' }}>{route.params.searchParams.pickUpDate.format('MMM DD, h:mm')}</Text>
                        </View>

                        <View style={{ width: '100%' }}>
                          <Text style={{ fontSize: 18, textAlign: 'left', fontFamily: SF_UI_Display_Bold }}>{route.params.searchParams.dropOffLocation.locationname}</Text>
                    ...
                    <View style={{ display: 'flex', flexDirection: 'row', width: '100%', paddingLeft: '3%', paddingRight: '3%' }}>
                      <TouchableOpacity style={{ width: '49%' }} onPress={() => setShowSortModal(true)} >
                        <View style={{ alignItems: 'center', display: 'flex', flexDirection: 'row', justifyContent: 'center', borderWidth: 1, borderColor: '#00000050' }}>
                          ...
                          <Text style={{ fontSize: 18, textAlign: 'center', width: '50%', fontFamily: SF_UI_Display_Bold }}>
                            Sort By
                        </Text>
                        </View>
                      </TouchableOpacity>
      ...
      {route.params.cars.length == 0 && (
        <Button
          ...
          {() => <Text style={{ fontFamily: SF_UI_Display_Bold, color: 'white', fontSize: 18 }}>Go back</Text>}
        </Button>
      )}
      {route.params.cars.length != 0 && (
        <Button
          ...
          {() => <Text style={{ fontFamily: SF_UI_Display_Bold, color: 'white', fontSize: 18 }}>BOOK NOW</Text>}
        </Button>
      )}
      <Modal
        ...
        <Layout style={{ height: '100%', padding: '3%' }}>
          <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
            ...
            <Text onPress={() => setShowSortModal(false)} style={{ fontFamily: SF_UI_Display_Bold }} category="h3">X</Text>
          </View>
      ...
      <Modal
        ...
        <Layout style={{ height: '100%', padding: '3%' }}>
          <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
            ...
            <Text onPress={() => setShowFilterModal(false)} style={{ fontFamily: SF_UI_Display_Bold }} category="h3">X</Text>
          </View>
          <ScrollView>
              ...
              {() => {
                return (
                  <>
                    ...
                    <Text style={{ fontFamily: SF_UI_Display_Bold, color: 'white', fontSize: 18 }}>Close</Text>
                  </>
                );
              }}
            </Button>
              ...
              {() => {
                return (
                  <>
                    ...
                    <Text style={{ fontFamily: SF_UI_Display_Bold, color: 'white', fontSize: 18 }}>Apply</Text>
                  </>
                );
              }}
            </Button>

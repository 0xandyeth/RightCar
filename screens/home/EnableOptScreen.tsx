    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <Layout style={{ flex: 1, padding: '5%', backgroundColor: 'white' }}>
        ...
        <Layout style={{ display: 'flex', flexDirection: 'column', backgroundColor: '#00000000', marginBottom: '60%' }}>
          <Text style={{ textAlign: 'center', fontFamily: SF_UI_Display_Bold }} category="h3">Do you want to enable 2-factor authentication</Text>
        </Layout>
        ...
        <Button
          ...
          {() => <Text style={{ color: 'white', fontFamily: SF_UI_Display_Bold, fontSize: 18}}>Enable it</Text>}
                            </Button>

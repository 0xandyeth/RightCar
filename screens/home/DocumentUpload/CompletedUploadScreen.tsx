                        ...
                        <>
                            <ScrollView keyboardShouldPersistTaps={"handled"} contentContainerStyle={{ flexGrow: 1 }}>
                                <View style={{ backgroundColor: 'white', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                    <Text style={{ color: 'black', textAlign: 'center', fontSize: 26, fontFamily: SF_UI_Display_Bold }} category='s2'>
                            ...
                            <Layout style={{ paddingTop: '2%' }}>
                                <Button
                                    ...
                                    {() => <Text style={{ fontFamily: SF_UI_Display_Bold, color: 'white', fontSize: 18 }}>Ok</Text>}
                                </Button>
                            </Layout>
                        </>
                    )
